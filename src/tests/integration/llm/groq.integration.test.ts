/**
 * Groq Adapter Integration Tests
 * Tests real API calls to Groq
 */
...
describeIfApiKey('Groq Adapter Integration', () => {
  ...
  it('should have fast inference time', async () => {
    const request: LLMRequest = {
      messages: [
        { role: 'user', content: 'Say "Fast"' }
      ]
    };
...
describe('Groq Adapter Without API Key', () => {
